...
export default function Signin({ dictionary, lang }: { dictionary: any, lang: string }) {
  const pageDict = dictionary.sign_in_page;
  return (
    <Wrapper>
        ...
        <div className="container">
          ...
          <div className="azzle-account-box">
            <form action="#">
              ...
              <div className="azzle-forget-password">
                <div className="azzle-check-field">
                  ...
                  <label htmlFor="css">{pageDict.remember_me}</label>
                </div>
                <Link href={`/${lang}/reset-password`}>{pageDict.forgot_password}</Link>
              </div>
            ...
            <div className="azzle-accout-footer">
              <p>{pageDict.no_account_text} <Link href={`/${lang}/sign-up`}>{pageDict.no_account_link}</Link></p>
            </div>
          </div>
        </div>
      </div>
